...
<template>
  <v-container>
    ...
    <div>
      <div v-if="locale == 'nl'">Het nieuwe seizoen start in september 2024.</div>
      <div v-if="locale == 'fr'">La nouvelle saison commence en septembre 2024.</div>
      <div v-if="locale == 'en'">The new season starts in September 2024.</div>
      <div v-if="locale == 'de'">Die neue Saison beginnt im September 2024.</div>
    </div>
