...
<div>
  <v-container>
    <v-row>
      <v-col cols="4" md="2">
        <v-img contain :src="require('@/assets/img/logo.svg')" />
      </v-col>
      <v-col cols=8 sm=7>
        <h1>{{ page.title }}</h1>
  ...
  <v-parallax  v-if="$vuetify.breakpoint.mdAndUp"
    :src="require('~/assets/img/chesscrowd_big.jpg')" height="400" />
  <v-parallax  v-if="$vuetify.breakpoint.sm"
    :src="require('~/assets/img/chesscrowd_medium.jpg')" height="300" />
  <v-parallax v-if="$vuetify.breakpoint.xs"
    :src="require('~/assets/img/chesscrowd_small.jpg')" height="200" />
  <v-container>
    <v-row class="mt-2">
