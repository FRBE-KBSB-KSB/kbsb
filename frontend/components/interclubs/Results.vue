...
<template>
  <v-container>
    <v-alert type="warning" v-if="resstatus == 'closed'" variant="outlined" 
      closable :text="t('icn.results_closed')" />
    <v-alert type="warning" v-if="resstatus == 'noclub'" variant="outlined" 
      closable :text="t('icn.select_club')" />
    <v-alert type="error" v-if="resstatus == 'noaccess'" variant="outlined" 
      closable :text="t('icn.perm_denied')" />
    <v-alert type="warning" v-if="resstatus == 'notopenyet'" variant="outlined" closable
      :text="t('Entry of the results starts on Sunday at 15h')" />
    <v-alert type="warning" variant="outlined"  v-if="resstatus == 'closed'" `closable
