...
<div>
  ...
  <div class="btn-language green darken-1">
    <v-btn text class="hover-darker btn-language" @click="$i18n.setLocale('nl')">NL</v-btn>
    <v-btn text class="hover-darker btn-language" @click="$i18n.setLocale('fr')">FR</v-btn>
    <v-btn text class="hover-darker btn-language" @click="$i18n.setLocale('de')">DE</v-btn>
    <v-btn text class="hover-darker btn-language" @click="$i18n.setLocale('en')">EN</v-btn>
  </div>
