      ...
      <v-container v-show="status_consulting">
        ...
        <v-row>
          <v-col cols="12" sm="6" md="4" xl="3">
            <v-card>
              <v-card-title> Club details </v-card-title>
              <v-card-text>
                <div>
                  <span class="fieldname">Long name</span>: {{ clubdetails.name_long }}
                </div>
                <div>
                  <span class="fieldname">Short name</span>: {{ clubdetails.name_short }}
                </div>
                <div>
                  <span class="fieldname">Federation</span>: {{ clubdetails.federation }}
                </div>
                <div>
                  <span class="fieldname">Website</span>: {{ clubdetails.website }}
                </div>
              </v-card-text>
            </v-card>
          </v-col>
          <v-col cols="12" sm="6" md="4" xl="3">
            <v-card>
              ...
              <v-card-text>
                <div>
                  <span class="fieldname">Bank account name</span>:
                  {{ clubdetails.bankaccount_name }}
                </div>
                <div>
                  <span class="fieldname">Bank account IBAN</span>:
                  {{ clubdetails.bankaccount_iban }}
                </div>
                <div>
                  <span class="fieldname">Bank account BIC</span>:
          ...
          <v-col cols="12" sm="6" md="4" xl="3">
            <v-card>
              ...
              <v-card-text>
                <div>
                  <span class="fieldname">Main email address</span>:
                  {{ clubdetails.email_main }}
                </div>
                <div>
                  <span class="fieldname">Email address Interclub</span>:
                  {{ clubdetails.email_interclub }}
                </div>
                <div>
                  <span class="fieldname">Email address administration</span>:
                  {{ clubdetails.email_admin }}
                </div>
                <div>
                  <span class="fieldname">Email address finance</span>:
          ...
          <v-col cols="12" sm="6" md="4" xl="3">
            <v-card>
              <v-card-title> Playing details </v-card-title>
              <v-card-text>
                <div>
                ...
                <div v-for="(h, d) in clubdetails.openinghours" :key="d">
                  <div v-show="h.length"><span class="fieldname">d</span>: {{ h }}</div>
                </div>
              </v-card-text>
            </v-card>
          </v-col>
            ...
            <v-card class="elevation-5">
              ...
              <v-card-text>
                ...
                <v-text-field
                  ...
                  label="Email address Interclub"
                />
                <v-text-field
                  v-model="clubdetails.email_admin"
                  label="Email address administration"
                />
                <v-text-field
